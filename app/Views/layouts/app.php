...
<body style="background-image: url('<?= base_url('backend_assets/img/bg-login2.png'); ?>'); background-repeat: no-repeat; background-position: center; height: 100%; background-size: cover;">
